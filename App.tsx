        ...
        <div className="min-h-screen flex flex-col items-center justify-start p-4 sm:p-6 lg:p-8">
            ...
            <footer className="text-center py-6 mt-auto">
                <div className="flex justify-center items-center space-x-6 mb-4">
                    <a href="https://www.youtube.com/@luke1618gamer" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white text-sm font-medium hover:underline transition-colors">
                        YouTube
                    </a>
                    <a href="https://www.tiktok.com/@hoangcao2704" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white text-sm font-medium hover:underline transition-colors">
                        TikTok
                    </a>
                    <a href="https://www.linkedin.com/in/hoangminhcao" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white text-sm font-medium hover:underline transition-colors">
                        LinkedIn
                    </a>
                </div>
                <p className="text-white font-bold text-sm">© 2025 Developed by MrLuke1618. All rights reserved.</p>
            </footer>
        </div>
    );
};
